...
while not done:
    ...
    # 5 pixels wide.
    # pygame.draw.line(screen, (0,255, 0), [100, 100], [300, 400], 9)
 
    # # Draw on the screen several lines from (0,10) to (100,110)
    # # 5 pixels wide using a loop
    # for y_offset in range(0, 100, 10): # 0, 10, 20, ..., 90
    ...
    pygame.draw.rect(screen, (random.randrange(0,255), random.randrange(0, 256), random.randrange(0,256)),
                            [20, 20, random.randrange(10,500), 100])
